...
int mostrarAlumnosDeUnaCarrera(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc);
void mostraInformes(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc);
...
int main()
{
    ...
    do
    {
        ...
        case 6:
            mostraInformes(lista, TAM, carreras, TAMC);
            break;
...
int mostrarAlumnosDeUnaCarrera(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc)
{
    ...
    for(int i; i<ta; i++)
    {
        if(listaAlumnos[i].isEmpty == 1)
        {
            for(int j; j<tc; i++)
            {
                if(listaAlumnos[i].idCarrera == listaCarreras[j].id)
                {
                    printf("%s", listaAlumnos[i].idCarrera);
                    value = 1;
                }
            }
        }
