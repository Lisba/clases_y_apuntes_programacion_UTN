...
void mostrarAlumnoCarrera(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc, int idCarrera);
void mostrarAlumnosDeUnaCarrera(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc);
void mostrarAlumnosPorCarrera(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc);
void mostrarCantidadDeAlumnosPorCarrera(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc);
int cantidadDeAlumnos(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc);
...
void mostrarAlumnoCarrera(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc, int idCarrera)
{
    for(int i=0; i<ta; i++)
    {
        if(listaAlumnos[i].idCarrera == idCarrera && listaAlumnos[i].isEmpty == 0)
        {
            mostrarAlumno(listaAlumnos[i], listaCarreras, tc);
        }
    }
}
...
void mostrarAlumnosDeUnaCarrera(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc)
{
    ...
    mostrarCarreras(listaCarreras, tc);
    printf("Seleccione un id:");
    scanf("%d", &id);

    for(int i=0; i<ta; i++)
    {
        if(id == listaCarreras[i].id)
        {
            mostrarAlumnoCarrera(listaAlumnos, ta, listaCarreras, tc, id);
        }
    }
}
...
void mostrarAlumnosPorCarrera(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc)
{
    ...
    for(int i=0; i<tc; i++)
    {
        cargarDescCarrera(listaCarreras[i].id, listaCarreras, tc, desc);
        printf("Carrera: %s\n\n", desc);
        mostrarAlumnoCarrera(listaAlumnos, ta, listaCarreras, tc, listaCarreras[i].id);
    }
}
...
int cantidadDeAlumnos(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc)
{
    ...
    for(int i=0; i<tc; i++)
    {
        if(listaAlumnos[i].idCarrera == listaCarreras[i].id)
        {
            contador++;
        }
    }
...
void mostrarCantidadDeAlumnosPorCarrera(eAlumno listaAlumnos[], int ta, eCarrera listaCarreras[], int tc)
{
    ...
    for(int i=0; i<tc; i++)
    {
        cantidad = cantidadDeAlumnos(listaAlumnos, ta, listaCarreras, tc);
        printf("%d", cantidad);
    }
}
